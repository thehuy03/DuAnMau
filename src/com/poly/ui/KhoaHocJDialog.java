        ...
        try {
            ...
            for (KhoaHoc kh : list) {
                Object[] row = {
                    ...
                    kh.getThoiLuong(),
                    kh.getHocPhi(),
                    DateHelper.toString(kh.getNgayKG(), "MM/dd/yyyy"),
                    kh.getMaNV(),
                    DateHelper.toString(kh.getNgayTao(), "MM/dd/yyyy")
                };
                model.addRow(row);
            }
        } 
...
//       this.updateStatus();
    ...
    void setForm(KhoaHoc kh){
        ...
        txtNgayKG.setText(DateHelper.toString(kh.getNgayKG(), "MM/dd/yyyy"));
        txtHocPhi.setText(String.valueOf(kh.getHocPhi()));
        txtThoiLuong.setText(String.valueOf(kh.getThoiLuong()));
        txtMaNV.setText(kh.getMaNV());
        txtNgayTao.setText(DateHelper.toString(kh.getNgayTao(), "MM/dd/yyyy"));
    ...
    KhoaHoc getForm(){
        ...
        KhoaHoc kh = new KhoaHoc();
        kh.setMaCD(chuyenDe.getMaCD());
        kh.setNgayKG(DateHelper.toDate(txtNgayKG.getText(), "MM/dd/yyyy"));
        kh.setHocPhi(Double.valueOf(txtHocPhi.getText()));
        kh.setThoiLuong(Integer.valueOf(txtThoiLuong.getText()));
        kh.setGhiChu(txtGhiChu.getText());
        kh.setMaNV(Auth.user.getMaNV());
        kh.setNgayTao(DateHelper.toDate(txtNgayTao.getText(), "MM/dd/yyyy"));
